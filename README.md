...
<img src="samples/s7.png" width="300" alt="AI 学习助手对话" />

翻到答案面时右下角出现悬浮入口，点击即可唤起 AI 助手「兔叽咪」。它会自动读取当前题目与标准答案作为上下文，围绕本题为你举例、拓展相关考点、给出记忆建议；也支持自由追问。回答采用流式输出、Markdown 渲染（含代码高亮），断流可一键「重新生成」。
