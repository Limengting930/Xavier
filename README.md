...
<img src="samples/s8.png" width="300" alt="AI 学习助手悬浮入口" /> <img src="samples/s7.png" width="300" alt="AI 学习助手对话面板" />

翻到答案面时，右下角会出现悬浮机器人入口（左图红框处），点击即可唤起 AI 助手「兔叽咪」，弹出对话面板（右图）。它会自动读取当前题目与标准答案作为上下文，围绕本题为你举例、拓展相关考点、给出记忆建议，也支持自由追问。面板底部内置「举个例子 / 相关题目 / 学习建议」快捷提问，回答采用流式输出、Markdown 渲染（含代码高亮），断流可一键「重新生成」。
