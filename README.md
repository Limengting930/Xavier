...
<img src="samples/s2.png" width="300" alt="学习卡片题面" />

卡片正面展示题目（支持图文），聚焦一个知识点。点击卡片即可翻到答案面。

### 答案与评分 —— 快速看答案、评估掌握度

<img src="samples/s3.png" width="300" alt="学习卡片答案页" />

翻到答案面可快速查看完整解析（关键词、易错点、面试追问等），并选择自己对这道题的掌握程度（未掌握 / 模糊 / 已掌握），系统据此安排下次复习时间。点击右下角图标即可唤起 AI 助手。

### AI 学习助手 —— 翻卡即问，随学随答

<img src="samples/s4.png" width="300" alt="AI 学习助手对话面板" />

AI 助手「兔叽咪」会自动读取当前题目与标准答案作为上下文，围绕本题为你举例、拓展考点、给出记忆建议，也支持自由追问。回答采用流式输出、Markdown 渲染（含代码高亮），断流可一键「重新生成」。
...
<img src="samples/s5.png" width="300" alt="上传本地文档" />

在题库页上传本地文档（`md / Word / PDF`），AI 自动解析内容并拆成一张张记忆卡片，无需手动录题。

<img src="samples/s6.png" width="300" alt="卡片生成进度" />

生成过程实时展示进度，逐段解析、支持随时取消，不必干等。

<img src="samples/s7.png" width="300" alt="生成成功" />

生成成功后提示卡片数量，可一键进入题库查看这批新卡片。

### 题库管理 —— 自建、命名、随心组织

<img src="samples/s8.png" width="300" alt="题库列表（含用户上传题库）" />

题库页按题库分组展示：内置「AI 面试题库」+ 你上传的每一个题库并列呈现，每个题库直观显示学习进度与上次学习时间，点击进入该题库的题目列表。

<img src="samples/s9.png" width="300" alt="题库重命名" />

上传的题库可随时重命名（自动校验重名），也支持增量更新与删除，方便长期维护自己的知识库。

<img src="samples/s10.png" width="300" alt="首页选择今日学习题库" />

在首页可指定「今天想学习哪个题库」，让每日学习目标只从选定题库中安排，专注攻克某个方向。
...
<img src="samples/s12.png" width="300" alt="个人主页" />

展示个人学习信息、已获成就与学习日历，坚持了多少天、哪天学过，都看得见。

### 成就体系 —— 让坚持被看见

<img src="samples/s13.png" width="300" alt="成就列表" />

连续学习、掌握题库等里程碑成就徽章一览，达成即点亮，正反馈拉满。
